...
// Enhanced notification helper with real-time emission
const createNotificationHelper = async (type, fromUserId, toUserId, blogId = null, io) => {
  try {
    ...
    if (io) {
      io.to(toUserId.toString()).emit('receiveNotification', populatedNotification);
    }
...
export const follower = async (req, res) => {
  try {
    ...
    if (!user.followers.includes(loggedInUserId)) {
      ...
      await createNotificationHelper('follow', loggedInUserId, userId, null, io);
...
export const handleLike = async (req, res) => {
  try {
    ...
    // Create and emit notification
    await createNotificationHelper('like', userId, toUserId, blogId, io);
...
export const handleComment = async (req, res) => {
  try {
    ...
    // Create and emit notification
    await createNotificationHelper('comment', userId, toUserId, blogId, io);
...
export const unfollow = async (req, res) => {
  try {
    ...
    if (loggedInUser.following.includes(userId)) {
      ...
      // Create and emit notification
      await createNotificationHelper('unfollow', loggedInUserId, userId, null, io);
